...
var MatchScroll = /** @class */ (function (_super) {
    ...
    MatchScroll.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "AwesomeColumnSubContent", ref: this.element, style: __assign(__assign({}, this.props.style), { overflow: "scroll" }), onMouseEnter: function () {
