...
var MatchScroll = /** @class */ (function (_super) {
    ...
    MatchScroll.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { ref: this.element, style: __assign(__assign({}, this.props.style), { overflow: "scroll" }), onMouseEnter: function () {
                ...
                if (_this.state.isActive) {
                    ...
                    var fractionToTop = 100 *
                        (e.target.scrollTop /
                            (e.target.scrollHeight - window.innerHeight));
                    _this.props.updateLength(fractionToTop);
                }
            } }, this.props.children));
    };
    return MatchScroll;
