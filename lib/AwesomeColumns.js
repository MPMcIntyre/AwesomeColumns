...
var Column = /** @class */ (function (_super) {
    ...
    function Column(props) {
        ...
        var _this = _super.call(this, props) || this;
        // Column style
        _this.columnStyle = __assign(__assign({}, props.style), { gridColumn: _this.props.columns
                ? "span {this.props.columns}"
                : ((_a = _this.props.style) === null || _a === void 0 ? void 0 : _a.gridColumn)
                    ? (_b = _this.props.style) === null || _b === void 0 ? void 0 : _b.gridColumn
                    : "" });
        // ChildStyle
        _this.childStyle = {
            display: "grid",
            alignContent: "center",
            padding: ((_c = _this.props) === null || _c === void 0 ? void 0 : _c.padding) ? _this.props.padding : "0.5rem",
    ...
    Column.prototype.render = function () {
        return (React.createElement("div", { className: "AwesomeColumn", style: this.columnStyle },
            React.createElement("div", { className: "AwesomeColumnContent", style: this.childStyle }, this.props.children)));
    };
    return Column;
}(React.Component));
export { Column };
